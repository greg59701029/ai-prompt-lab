...
def main():
    ...
    assert_contains(html, 'id="preset-name-input"', "index.html")
    assert_contains(html, 'id="save-preset-btn"', "index.html")
    assert_contains(html, 'id="saved-preset-list"', "index.html")
    ...
    assert_contains(css, ".saved-presets", "styles.css")
    assert_contains(css, ".saved-preset-row", "styles.css")
